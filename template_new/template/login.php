...
if(isset ($_POST['Email']) and isset($_POST['Password'])) {
   ...
   if( $result['row']==1) {
      ...
      {
          ?>
        <meta http-equiv="Refresh" content="1; url=http://localhost/template_new/template/index.html">
    ...
    ?>
    <meta http-equiv="Refresh" content="2; url=http://localhost/template_new/template/back/accordion.html">
