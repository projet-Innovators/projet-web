...
<!-- Mirrored from demo.hasthemes.com/marten-preview/marten-v1/shop-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Apr 2021 22:28:35 GMT -->
...
<body>
                            ...
                            <div class="header-cart same-style">
                                ...
                                <div class="shopping-cart-content">
                                    ...
                                    <div class="shopping-cart-btn">
                                        <a href="hiv.php?quantity=3">livrer</a>
            ...
            <div class="row flex-row-reverse">
                <div class="col-lg-9">
                    ...
                    <div class="product-show shorting-style">
                                   ...
                                   <?PHP include "Commandes_ajouter.php" ?>
                               </div>
 ...
 select.add(option);
 var total=parseFloat(document.getElementById("prix").innerHTML)+parseFloat(prix);
 document.getElementById("prix").innerHTML=total.toFixed(2) +" DT";
 
 var adresse= document.getElementById("adr");
 var btnbestellen= document.getElementById("commander");
 
 if(adresse.value.length<1 || select.length<1){
                                        ...
                                        <div class="product-wrapper mb-10">
                                            <div class="product-img">
                                              ...
                                              echo"   <img src='".$row['image']."'
                                               alt=''
                                                onclick=panier('".$row['nom']."','".$row['prix']."'); > ";
