        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-area-chart"></i>livraisons</a>
                        <ul class="sub-menu children dropdown-menu">
    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
            ...
            <div class="col-sm-8">
                ...
                <div class="container">
                              <div class="jumbotron">
<caption> ajouter une livraison
                             </caption>
                    <form method="POST" name="MonForm" action="ajoutlivraison.php" onsubmit="return valider()">
                             
                                    <div class="input-group">
                           Id : <br> <input class="form-control" type="text"  pattern="[0-9a-zA-Z-\.]{0,12}" name="id">
                        </div>
                               
                                <br/>
                        <div class="input-group">
                            Nom : <br/>
                                    <input type="text" name="nom"  class="form-control" placeholder="Nom de livraison">
                        </div>
                        <br/>
                        ...
                        <div class="input-group">
                            Date : <br/>
                                    <input type="date" name="date"  class="input--style-1 js-datepicker" >
                        </div>
...
<br/>
                      <div class="input-group">
                           adresse : <br> <input class="form-control" type="text"  pattern="[0-9a-zA-Z-\.]{0,12}" name="adresse">
                        </div>
                        <div>
                            total<input type="text"  name="total"></div>
