...
xmlhttp.send();
        ...
        <section>
                <div class="col-lg-6">
                 ...
                 <input class="form-control" name="livreur" id="txtHint" type="text"  >
                </div>
<br/>
<br/>
 <div class="form-group">
                ...
                <?php
                       ...
                       $livreur1c=new livreurc();
                                              ...
                                              ?>
                                               <th>addresse</th>
                                 <td><select name="adresse" id ="select" onclick="myfun(this.value)">
                                               <?php
                                     foreach ($result2 as $row) {
                                     ?>
                                       <option value="<?PHP echo   $row['localisation']; ?>"><?PHP echo $row['localisation'] ?></option>
                                     <?PHP
                                     }
                                     ?>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                 quantité <input class="form-control" name="total" id="total" type="total" placeholder="entrer quantité" >
                </div>
