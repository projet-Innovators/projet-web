...
<div class="container">
 ...
 <div class="container my-2">
             <input class="col-10" type="text" name="AfficherClasse" onkeyup="myFunction()" placeholder="rechercher par Objet" id="myInput">
    ...
    foreach($listeEmployes as $row){
        ...
        <tr>
            ...
            <td  ><a href="modifierlivraison.php?id=<?PHP echo $row['id']; ?>" class="btn btn-success btn-block"  >
                    Modifier</a></td>
                    <td ><a href="send_mail.php?id=<?PHP echo $row['id']; ?>"  class="btn btn-warning btn-block">
                    traiter</a></td>
        </tr>
