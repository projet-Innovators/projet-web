...
?>
<h3 class="text-center text-info">Modifier Utilisateur</h3>
<form method="POST">
<table>
...
<td></td>
<td class="button-box" >                                                   
 <button type="submit" name="modifier" value="modifier" ><span>modifier</span></button>
</td>
</tr>
<tr>
<td></td>
...
if (isset($_POST['modifier'])){
	$Utilisateur=new Utilisateur($_POST['Nom'],$_POST['Prenom'],$_POST['Date_de_naissance'],$_POST['Sexe'],$_POST['Role'],$_POST['Password'],$_POST['Email']);
