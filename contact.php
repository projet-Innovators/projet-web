...
<!-- Mirrored from demo.hasthemes.com/marten-preview/marten-v1/contact.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Apr 2021 22:28:45 GMT -->
                    ...
                    <div class="col-xl-2 col-lg-2 col-md-8 col-sm-8 col-7">
                        <div class="search-login-cart-wrapper">
                            ...
                            <div class="header-login same-style">
                                <a href="login-register.php"><i class="icon-user icons"></i></a>
                            </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="contact-info-wrapper text-center mb-30">
                        ...
                        <div class="contact-info-content">
                            ...
                            <p>Mobile: 00216 25 212 148</p>
                            <p>Fax: 00216 29 537 066</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="contact-info-wrapper text-center mb-30">
                        ...
                        <div class="contact-info-content">
                            ...
                            <p><a href="#">innovators@esprit.tn</a></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="contact-message-wrapper">
                        <h4 class="contact-title">CLAIM</h4>
                        <div class="contact-message">
                            <form class="was-validated" action="AjouterReclamation.php" method="post">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="contact-form-style mb-20">
                                            <div class="form-group">
                                                        <input type="text" name="subject" class="form-control" required pattern="[0-9.,]{1,12}" placeholder="Enter your Subject">
                                                    </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
...
<textarea onblur="calculeLongueur();" onfocus="calculeLongueur();" onkeydown="calculeLongueur();" onkeyup="calculeLongueur();" id="autre" name="message" class="form-control" required pattern="[0-9a-zA-Z-\.]{3,400}" placeholder="Message"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="submit" name="add" class="submit btn-style" value="SEND CLAIM">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright text-center">
                            <p>Copyright © <a href="#">Innovators.</a> All Right Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
