                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">Gestion Promotion</a>
                                                        </li>
                                                        <li class="breadcrumb-item"><a href="checkout_produit.php">Promotion</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                ...
                                                <hr>
                                                <form class="was-validated" action="AjouterPromo.php" method="POST" enctype="multipart/form-data">
...
<table class="table table-hover">
  ...
  ?>
    ...
    <tbody>
      <tr>
        <td><?PHP echo $nomp; ?></td>
        <td><?PHP echo $prixp; ?></td>
        <td><?PHP echo $prixnouv; ?></td>
