                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.navigation">Gestion Produit</div>
                    ...
                    <div class="pcoded-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    ...
                                    ?>
                                            ...
                                            $listeCat = $Cat1C->recupererAllCategorie();
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-3">
                                                                ...
                                                                <div class="form-group">
                                                                    <input class="form-control" required pattern="[0-9a-zA-Z-\.]{3,20}" placeholder="Entre the name of product" type="text" name="Nom" value="<?PHP echo $Nom ?>">
                                                                </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="dropdown-header" value="<?PHP echo $IdCat ?>" name="Idcat">
                                                                        <?PHP
                                                                ...
                                                                <div class="form-group">
                                                                    <textarea class="form-control" required pattern="[0-9a-zA-Z-\.]{3,120}" placeholder="Informations About the products" name="Description" value="<?PHP echo $Description ?>"></textarea>
                                                                </div>
                        ...
                        <?PHP
                                        ...
                                        if (isset($_POST['modifier'])) {
                                            ...
                                            $Produit=new Produit($_POST['id_ini'],$_POST['Idcat'],$_POST['Nom'],$_POST['Prix'],$_POST['Image'],$_POST['Quantite'],$_POST['Description']);
