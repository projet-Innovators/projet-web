                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="checkout_categorie.php">Categorie</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    if (isset($_GET['id'])) {
                                        ...
                                        $result = $categorieC1->recupererCategorie($_GET['id']);
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <form class="was-validated" method="POST">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="text" name="nom" class="form-control" required pattern="[0-9a-zA-Z,/. ]{3,20}" placeholder="Enter Name Of the Categorie">
                                                            </div>
