                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="page-header-breadcrumb">
                                                    <ul class="breadcrumb-title">
                                                        ...
                                                        <li class="breadcrumb-item"><a href="#!">Gestion Reclamation</a>
                                                        </li>
                                                        <li class="breadcrumb-item"><a href="checkout_reclamation.php">Reclamation</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="page-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <h3 class="text-center text-info">Consult claim</h3>
                                                <hr>
                                            ...
                                            $listeReclam = $reclamC->afficherReclamtions();
                                                ...
                                                ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <form method="POST" action="pdfReclam.php">
                                                          ...
                                                          {
                                                          ?>
                                                        <td style="width: 5%"><a class="btn btn-success btn-block" href="ModifierReclamation.php?id=<?PHP echo $row['id']; ?>">
                                                                Traitée</a></td>
                                                           <?php
                                                          }
                                                           ?>
